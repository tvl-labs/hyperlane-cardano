...
export type MerkleTreeType = MerkleTreesByBlockNumberResponseType['merkleTrees'][number]
export type MessagesByBlockRangeResponseType = operations['messagesByBlockRange']['responses']['200']['content']['application/json']
export type MessageResponseType = MessagesByBlockRangeResponseType['messages'][number]['message']