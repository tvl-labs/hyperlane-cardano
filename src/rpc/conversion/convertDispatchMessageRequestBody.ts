import { type DispatchMessageRequestBody } from "../types";
...
export function convertDispatchMessageRequestBody(
  requestBody: DispatchMessageRequestBody
): OutboxDispatchedMessage {
  return {
