...
import { lastFinalizedBlockNumberService, merkleTreeService, messagesService } from './services/services';
...
app.post(
  "/api/outbox/dispatch",
  async function (req: Request<unknown, unknown, DispatchMessageRequestBody>, res: Response<DispatchMessageResponseType>, _) {
...
console.log(`Starting RPC on port ${PORT} in ${IS_MOCK_ENVIRONMENT ? 'mock' : 'production'} environment`)
