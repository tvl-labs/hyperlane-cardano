...
/// struct for typed errors of method [`api_outbox_messages_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ApiOutboxMessagesGetError {
...
/// struct for typed errors of method [`merkle_tree_by_block_number`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum MerkleTreeByBlockNumberError {
    UnknownValue(serde_json::Value),
}
...
pub async fn api_outbox_messages_get(configuration: &configuration::Configuration, ) -> Result<Vec<crate::models::Message>, Error<ApiOutboxMessagesGetError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/outbox/messages", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ApiOutboxMessagesGetError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn merkle_tree_by_block_number(configuration: &configuration::Configuration, block_number: i32) -> Result<crate::models::MerkleTreeByBlockNumber200Response, Error<MerkleTreeByBlockNumberError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/indexer/merkleTree/{blockNumber}", local_var_configuration.base_path, blockNumber=block_number);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MerkleTreeByBlockNumberError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
